...
const blogMetaChFr: Record<string, string> = {
  ...
  'blog.article.premi-cassa-malati-svizzera-2026.imageAlt': 'Vue de Bellinzona et de ses châteaux médiévaux, chef-lieu de l\'un des cantons les plus chers pour l\'assurance maladie.',
    ...
    'blog.article.bloccare-ridurre-ristorni-frontalieri-roma.excerpt': 'Levicoli demande à Berne d\'interrompre ou de réduire les restitutions aux frontaliers en raison de la pression fiscale. Au moins deux cas dépassant 30 millions ont produit des résultats.',
    ...
    'blog.article.assegni-familiari-canton-svitto.title': 'Allocations familiales dans le canton de Schwytz',
    ...
    'blog.article.mercato-affitti-cantone-svitto.title': 'Marché locatif à Schwytz : loyers moyens et droit du bail',
    ...
    'blog.article.mercato-gli-affitti-canton-nidvaldo.title': 'Marché locatif à Nidwald : loyers moyens et droit du bail',
    ...
    'blog.article.annuncio-discriminatorio-zurigo-lpar.title': 'Annonce discriminatoire Zurich : ce que prévoit la LPar',
    'blog.article.annuncio-discriminatorio-zurigo-lpar.excerpt': 'Une menuiserie de Zurich a publié une annonce avec des critères de sexe et d\'âge. Un avocat explique ce que prévoit la loi suisse sur la discrimination.',
    'blog.article.annuncio-discriminatorio-zurigo-lpar.imageAlt': 'Environnement de travail professionnel en Suisse mettant l\'accent sur l\'embauche et le droit du travail',
    ...
    'blog.article.esportazioni-svizzera-luglio-record.title': 'Les exportations suisses s\'accélèrent en juillet 2026',
    'blog.article.esportazioni-svizzera-luglio-record.excerpt': 'En juillet 2026, les exportations suisses atteignent CHF 27,8 milliards (+13,8% par mois). Le secteur pharmaceutique croît de 25 %. Surplus balance commerciale : CHF 8,1 milliards.',
    'blog.article.esportazioni-svizzera-luglio-record.imageAlt': 'Conteneurs de fret dans une installation portuaire suisse avec les Alpes en arrière-plan',
    ...
    'blog.article.aprire-attivita-lucerna-forme-giuridiche.title': 'Ouvrir une entreprise à Lucerne : guide du registre du commerce',
    'blog.article.aprire-attivita-lucerna-forme-giuridiche.excerpt': 'Ouvrir des activités à Lucerne : formes juridiques, inscription au registre du commerce, capitaux minimaux, taxes et obligations d\'assurance. Procédure étape par étape.',
    'blog.article.aprire-attivita-lucerna-forme-giuridiche.imageAlt': 'Vue du Lac de Lugano avec montagnes en arrière-plan — paysage suisse',
    ...
    'blog.article.lucerna-salari-formazione.title': 'Salaires et marché du travail canton de Lucerne',
    'blog.article.lucerna-salari-formazione.excerpt': 'Niveaux de salaire par niveau de formation, secteurs qu\'ils embauchent, conventions collectives. Comment évaluer une offre et calculer le net en Suisse.',
    'blog.article.lucerna-salari-formazione.imageAlt': 'Environnement de travail moderne en Suisse avec des professionnels en réunions et au bureau',
    ...
    'blog.article.naturalizzazione-friburgo-requisiti-procedura.title': 'Naturalisation canton de Fribourg : exigences et procédure',
    'blog.article.naturalizzazione-friburgo-requisiti-procedura.excerpt': 'Guide complet de la naturalisation ordinaire dans le canton de Fribourg : procédure fédérale, exigences linguistiques, taxes et délais municipaux.',
    'blog.article.naturalizzazione-friburgo-requisiti-procedura.imageAlt': 'Certificat de naturalisation suisse devant la mairie de Fribourg',
    ...
    'blog.article.apprendistato-zurigo-contratto-tirocinio.title': 'Apprentissage à Zurich : comment trouver sa place d\'apprentissage',
    'blog.article.apprendistato-zurigo-contratto-tirocinio.excerpt': 'Guide pratique de l\'apprentissage dans le canton de Zurich : recherche, contrat, rémunération et maturité professionnelle. Tout ce que vous devez savoir sur le système de formation double suisse.',
    'blog.article.apprendistato-zurigo-contratto-tirocinio.imageAlt': 'Des apprentis lors d\'une formation professionnelle pratique dans une école suisse',
    ...
    'blog.article.imposte-appenzello-esterno-aliquote.title': 'Impôts cantonaux Appenzell Extérieur : taux et déductions',
    'blog.article.imposte-appenzello-esterno-aliquote.excerpt': 'Guide complet des impôts cantonaux et communaux à Appenzell Extérieur : structure à 3 niveaux, taux, déductions admises, délais déclaratifs et procédure en ligne.',
    'blog.article.imposte-appenzello-esterno-aliquote.imageAlt': 'Bâtiment de l\'administration fiscale cantonale suisse avec paysage alpin',
    ...
    'blog.article.ordinanze-trasporti-consultazione-videosorveglianza.title': 'Ordonnances de transport : consultation ouverte sur la vidéosurveillance',
    'blog.article.ordinanze-trasporti-consultazione-videosorveglianza.excerpt': 'Consultation publique du 26 août au 26 novembre 2026 pour deux ordonnances fédérales sur la vidéosurveillance et la bodycam dans les transports publics suisses.',
    'blog.article.ordinanze-trasporti-consultazione-videosorveglianza.imageAlt': 'Gare ferroviaire suisse avec voyageurs et panneaux d\'information numériques',
    ...
    'blog.article.acquisto-casa-nidvaldo-guida.title': 'Acheter une maison à Nidwald : guide hypothécaire et coûts',
    'blog.article.acquisto-casa-nidvaldo-guida.excerpt': 'Guide pratique pour l\'achat d\'une maison à Nidwald : fonds propres, taxes sur les transferts, options d\'hypothèque et sept étapes opérationnelles du budget à la remise des clés.',
    'blog.article.acquisto-casa-nidvaldo-guida.imageAlt': 'Village traditionnel du canton de Nidwald avec vue alpine',
    ...
    'blog.article.lamal-zurigo-come-scegliere.title': 'LAMal 2026 : comment choisir en Suisse',
    'blog.article.lamal-zurigo-come-scegliere.excerpt': 'L\'assurance maladie LAMal est obligatoire pour tous les résidents. Voici comment vous orienter entre franchises (CHF 300–2500), choix de la caisse et subventions cantonales en 2026.',
    'blog.article.lamal-zurigo-come-scegliere.imageAlt': 'Réception de clinique médicale moderne avec patient en consultation avec médecin généraliste',
    ...
    'blog.article.sanzioni-onu-2026-aggiornamento.title': 'Mise à jour des sanctions de l’ONU : implications pour les entreprises suisses',
    'blog.article.sanzioni-onu-2026-aggiornamento.excerpt': 'Le Comité des sanctions de l’ONU a mis à jour la liste des individus, entreprises et organisations soumis à des sanctions.',
    'blog.article.sanzioni-onu-2026-aggiornamento.imageAlt': 'Vue aérienne du lac de Lugano avec les montagnes en arrière-plan, Suisse.',
    'blog.article.swiss-life-taglio-posti-lavoro-2028.title': 'Swiss Life supprimera 600 emplois d’ici la fin 2028',
    'blog.article.swiss-life-taglio-posti-lavoro-2028.excerpt': 'L’assureur vie a annoncé un plan de restructuration pour améliorer l’efficacité opérationnelle.',
    'blog.article.swiss-life-taglio-posti-lavoro-2028.imageAlt': 'Vue aérienne du paysage urbain de Lugano avec le siège de Swiss Life.',
    ...
    'blog.article.margine-manovra-agricoltori-svizzera.title': 'Agriculture 2030 : marge de manœuvre élargie',
    'blog.article.margine-manovra-agricoltori-svizzera.excerpt': 'Conseil fédéral lance la consultation PA30+ jusqu\'au 8 décembre. 13,8 milliards CHF pour réformer les paiements agricoles, renforcer la sécurité alimentaire suisse.',
    'blog.article.margine-manovra-agricoltori-svizzera.imageAlt': 'Paysage rural suisse avec champs et montagnes en arrière-plan, symbole du secteur agricole national',
    ...
    'blog.article.pa30-autonomia-agricoltori.title': 'PA 2030+ : plus de liberté pour les agriculteurs suisses',
    'blog.article.pa30-autonomia-agricoltori.excerpt': 'Le Conseil fédéral lance une consultation sur PA30+ : autonomie de gestion, moins de bureaucratie, numérisation et 13,8 milliards CHF d\'investissement pour l\'agriculture 2030-2033.',
    'blog.article.pa30-autonomia-agricoltori.imageAlt': 'Champ agricole suisse avec cultures mûres pendant l\'heure dorée, symbolise les changements de la politique agricole 2030+',
    ...
    'blog.article.franco-euro-minimi-anno.title': 'Franc suisse au plus bas : ce que cela signifie pour les investisseurs',
    ...
    'blog.article.impresa-appenzello-esterno-registrazione.title': 'Enregistrer une entreprise à Appenzell externe',
    'blog.article.impresa-appenzello-esterno-registrazione.excerpt': 'Guide des passages, des formes juridiques, des frais d\'enregistrement et des obligations d\'assurance pour ceux qui ouvrent une entreprise dans le canton AR.',
    'blog.article.impresa-appenzello-esterno-registrazione.imageAlt': 'Bâtiment d\'administration cantonale suisse avec registre du commerce',
    ...
    'blog.article.economia-svizzera-crescita-q2-2026.title': 'L\'économie suisse s\'accélère, PIB +1,5% en 2026',
    'blog.article.economia-svizzera-crescita-q2-2026.excerpt': 'SECO confirme une forte croissance au Q2 2026 avec un PIB de +1,5%. Industrie manufacturière et chimico-pharmaceutique entraînent la reprise économique suisse.',
    'blog.article.economia-svizzera-crescita-q2-2026.imageAlt': 'Quartier d\'affaires suisse moderne reflétant l\'activité économique et la croissance du pays.',
    ...
    'blog.article.patente-estero-vaud-conversione.title': 'Permis étranger en Vaud : conversion et examens',
    'blog.article.patente-estero-vaud-conversione.excerpt': 'Procédure cantonale pour convertir un permis étranger en Vaud : examens théoriques et pratiques, cours obligatoires, documents requis et contacts Office de la circulation.',
    'blog.article.patente-estero-vaud-conversione.imageAlt': 'Route suisse en montagne avec signalisation routière, voiture et paysage alpin en arrière-plan.',
    ...
    'blog.article.imposte-cantonali-vallese-aliquote-deduzioni.title': 'Impôts cantonaux en Valais : taux et déductions',
    'blog.article.imposte-cantonali-vallese-aliquote-deduzioni.excerpt': 'Découvrez les taux et les déductions fiscales dans le canton du Valais, avec des détails sur les délais et le portail en ligne de l\'administration fiscale.',
    'blog.article.imposte-cantonali-vallese-aliquote-deduzioni.imageAlt': 'Vue panoramique du Lac Majeur avec les montagnes suisses en arrière-plan',
    ...
    'blog.article.aprire-attivita-soletta-costi-procedure.title': 'Ouvrir une entreprise à Soleure : coûts et procédures',
    'blog.article.aprire-attivita-soletta-costi-procedure.excerpt': 'Des formes juridiques aux frais d\'inscription au registre du commerce, les obligations d\'assurance : comment démarrer une entreprise dans le canton de Soleure.',
    'blog.article.aprire-attivita-soletta-costi-procedure.imageAlt': 'Un espace de bureau moderne suisse avec bureau, ordinateur et documents commerciaux.',
    'blog.article.aprire-attivita-soletta-commercio-costi.title': 'Ouvrir une entreprise canton de Soleure : guide registre et coûts',
    'blog.article.aprire-attivita-soletta-commercio-costi.excerpt': 'Comment démarrer une activité dans le canton de Soleure : formes juridiques, enregistrement commercial, fiscalité cantonale et prévoyance obligatoire (AVS, LPP, LAMal).',
    'blog.article.aprire-attivita-soletta-commercio-costi.imageAlt': 'Registre du commerce suisse avec comptoir d\'accueil moderne et design architectural contemporain',
    'blog.article.avviare-attivita-soletta-guida-completa.title': 'Ouvrir une entreprise à Soleure : formes juridiques, coûts et procédures',
    'blog.article.avviare-attivita-soletta-guida-completa.excerpt': 'Guide pratique pour la création d\'une entreprise dans le canton de Soleure : choix de la forme juridique, inscription au Registre du commerce, impôts et obligations d\'assurance.',
    'blog.article.avviare-attivita-soletta-guida-completa.imageAlt': 'Bâtiment administratif d\'une commune suisse, symbole de création d\'entreprise et enregistrement commercial',
    ...
    'blog.article.attacco-hacker-schweizerhof.title': 'Attaque hacker à l\'hôtel, alerté environ 10\'000 clients',
    'blog.article.attacco-hacker-schweizerhof.excerpt': 'L\'hôtel Schweizerhof de Lenzerheide a été victime d\'une attaque de hackers. Environ 10\'000 clients ont été alertés.',
    'blog.article.attacco-hacker-schweizerhof.imageAlt': 'Image d\'un hôtel suisse avec un ordinateur piraté en premier plan',
    ...
    'blog.article.hotel-lenzerheide-hacker-avviso.title': 'Attaque hacker Hotel Schweizerhof : 10.000 clients alertés',
    'blog.article.hotel-lenzerheide-hacker-avviso.excerpt': 'L\'Hôtel Schweizerhof de Lenzerheide victime d\'une attaque de hacker. Environ 10 000 clients avertis de possibles tentatives de fraude avec une offre fictive de 250 francs.',
    'blog.article.hotel-lenzerheide-hacker-avviso.imageAlt': 'Hôtel de luxe suisse avec montagnes en arrière-plan dans la lumière dorée alpine',
    ...
    'blog.article.patente-guida-appenzello-esterno-conversione.title': 'Permis de conduire Appenzell Extérieur : conversion et examens',
    'blog.article.patente-guida-appenzello-esterno-conversione.excerpt': 'Comment convertir le permis étranger en Appenzell Extérieur : examen théorique, pratique, cours et procédure auprès de l\'Office de la circulation cantonale.',
    'blog.article.patente-guida-appenzello-esterno-conversione.imageAlt': 'Bureau cantonal de circulation avec signalisation, lieu de conversion des permis de conduire.',
    'blog.article.avs-cassa-compensazione-canton.title': 'AVS et prestations : caisse de compensation cantonale',
    'blog.article.avs-cassa-compensazione-canton.excerpt': 'Comment fonctionne la caisse de compensation cantonale pour l\'AVS, le calcul de la rente et les prestations complémentaires pour ceux qui ont des lacunes de cotisation.',
    'blog.article.avs-cassa-compensazione-canton.imageAlt': 'Conseiller financier examinant les cotisations AVS dans un bureau cantonal suisse',
    ...
    'blog.article.zurich-hcl-gold-sponsor-2030.title': 'Zurich renouvelle avec HCL : Gold Sponsor jusqu\'en 2030',
    'blog.article.zurich-hcl-gold-sponsor-2030.excerpt': 'Zurich Assurances a renouvelé son partenariat avec le Hockey Club Lugano jusqu\'en 2030, confirmant ainsi son statut de Gold Sponsor.',
    'blog.article.zurich-hcl-gold-sponsor-2030.imageAlt': 'Vue panoramique du lac de Lugano avec le Hockey Club Lugano et Zurich Assurances',
    'blog.article.action-negozio-20esimo-schattdorf.title': 'Action accélère et ouvre le 20ème magasin',
    'blog.article.action-negozio-20esimo-schattdorf.excerpt': 'Action inaugure son 20ème magasin en Suisse à Schattdorf, Uri, le 17 septembre, avec 14 nouveaux recrutements locaux.',
    'blog.article.action-negozio-20esimo-schattdorf.imageAlt': 'Vue aérienne du nouveau magasin Action à Schattdorf, Uri, Suisse',
    ...
    'blog.article.bepi-colombo-missione-mercurio.title': 'BepiColombo vers Mercure : la mission dans la phase cruciale',
    'blog.article.bepi-colombo-missione-mercurio.excerpt': 'Après huit ans et plus de 10 milliards de kilomètres, la mission BepiColombo se prépare à l\'insertion orbitale de Mercure.',
    'blog.article.bepi-colombo-missione-mercurio.imageAlt': 'La sonde BepiColombo en approche de Mercure',
    ...
    'blog.article.melide-riqualifica-centro.title': 'Comment le noyau de Melide a changé grâce aux travaux',
    'blog.article.melide-riqualifica-centro.excerpt': 'Les travaux de requalification du centre de Melide ont été achevés le 6 septembre avec du granit d\'Iragna et du porphyre rose de Cuasso al Monte.',
    'blog.article.melide-riqualifica-centro.imageAlt': 'Centre-ville de Melide après travaux de rénovation',
    'blog.article.luna-wedler-golden-eye-award-zurigo.title': 'Festival Zurich : à la Suisse luna wedler le golden eye award',
    'blog.article.luna-wedler-golden-eye-award-zurigo.excerpt': 'L\'actrice suisse reçoit le prix pour être la première actrice suisse à remporter le Golden Eye Award.',
    'blog.article.luna-wedler-golden-eye-award-zurigo.imageAlt': 'Luna Wedler reçoit le Golden Eye Award lors de la cérémonie d\'ouverture du festival de Zurich.',
