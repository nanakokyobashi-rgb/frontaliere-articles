...
export const LABELS = [
  ...
  ['fu-reparked:1', 'd4c5f9', 'Riesumata dal parked-retry, generazione 1'],
  ['fu-reparked:2', 'd4c5f9', 'Riesumata dal parked-retry, generazione 2'],
  ['agent:decompose-queued', '1d76db', 'In coda per la decomposizione in sub-issue'],
  ['agent:decompose', '0e8a16', 'Decomposizione in corso (run planner)'],
  ['decomposed:1', 'c5def5', 'Gia decomposta in sub-issue (mai ri-decomporre); chiusa dal PARENT-CLOSE a figlie tutte chiuse'],
  ['from-decompose', 'bfd4f2', 'Atomica by-construction (nata da una decomposizione o giudicata tale dal planner)'],
