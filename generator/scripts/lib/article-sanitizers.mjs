...
/**
 * Vive qui, e non piu' come funzione privata di `create-article.mjs`, perche'
 * NON e' piu' il solo scrittore di body: `retranslate-blocking-bodies.mjs`
 * riscrive body-locale gia' pubblicati con l'uscita della STESSA cascata MT, e
 * una graffa spaiata non e' nel vocabolario di `runFactualityGates` — nessun
 * `critical` la intercetta. Una seconda copia privata sarebbe la stessa
 * divergenza che il commento di `unescapeForSingleQuoteTS` racconta per esteso.
 */
/**
 ...
 */
export function sanitizeBodyText(s) {
