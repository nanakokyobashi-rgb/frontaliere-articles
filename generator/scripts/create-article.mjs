...
import { collectBodySections, assertTranslationsPassFactualityGates } from './lib/translation-factuality-gate.mjs';
...
// `collectBodySections` vive in lib/translation-factuality-gate.mjs, accanto al
// gate che la usa.
...
// `assertTranslationsPassFactualityGates` vive in lib/translation-factuality-gate.mjs:
// i tre `refreshBodyFiles()` dei produttori secondari sono il TERZO percorso di
// scrittura e devono chiamare la stessa funzione, ma non possono importare questo
// modulo dalle gate di `node --test` (dipendenze statiche assenti senza `npm ci`).
