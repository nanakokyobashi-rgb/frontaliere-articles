...
const RC_TO_ENV = {
  ...
  SERVER_GITHUB_WEBHOOK_SECRET:   ['FRONTALIERE_GH_WEBHOOK_SECRET'],
  ...
  // lane (setup-claude-haiku-fallback/action.yml resolves HAIKU_FALLBACK_GATE
  // from it), but since 2026-09-24 it no longer enables the `claude` CLI:
  // the owner disabled the Haiku lane in code ("only Codex"), and
  // isClaudeCliFallbackEnabled() in ai-models.mjs is hard-wired to false.
