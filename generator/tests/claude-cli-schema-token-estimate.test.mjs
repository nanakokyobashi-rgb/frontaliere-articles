 ...
 * lo stesso, via `--json-schema` (vedi claude-cli-schema-required-loop.test.mjs,
 * PR #487) — un terzo mittente che il commento di `shouldUseSchemaMode` non
 * nominava. Risultato: ogni chiamata a `claude-cli/haiku` con uno schema veniva
 * sotto-contata di ~1805 byte ≈ 452 token, la stessa classe di difetto del caso
 * Groq gia' documentato nel sorgente, segno opposto.
 *
 ...
 * passa lo schema da `relaxSchemaForClaudeCli` (PR #487) prima di serializzarlo,
